...
def interactive_edges(image_path):
    ...
    while True:
        ...
        if choice == "1":
            ...
            lower = int(input("Enter lower Canny threshold: "))
            upper = int(input("Enter upper Canny threshold: "))
            ...
            kernel = int(
                input("Enter Gaussian kernel size (odd number): ")
            )
            ...
            kernel = int(
                input("Enter Median kernel size (odd number): ")
            )
...
interactive_edges("beautiful-and-inspiring-picture-detailing-a-bright-hot-air-balloon-over-river-pure-cozy-perfect-for-crea.jpeg.")